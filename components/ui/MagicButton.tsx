...
const MagicButton = ({
  ...
  return (
    <button onClick={handleClick} className="relative inline-flex h-12 w-full overflow-hidden rounded-lg p-[1px] border border-white focus:outline-none md:w-60 md:mt-10">
